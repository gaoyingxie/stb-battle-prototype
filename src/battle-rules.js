...
(function registerBattleRules(global) {
  ...
  const STATUS_DEFINITIONS = {
    ...
    attackDown: { label: "攻击降低", category: "attribute", negative: true, summary: "降低攻击属性，参与攻击伤害计算。" },
    strategyUp: { label: "谋略提高", category: "attribute", summary: "提高谋略属性，参与策略伤害和治疗量计算。" },
    strategyDown: { label: "谋略降低", category: "attribute", negative: true, summary: "降低谋略属性，参与策略伤害、防守谋略和治疗量计算。" },
    ...
    speedDown: { label: "速度降低", category: "attribute", negative: true, summary: "降低行动速度，影响行动顺序。" },
    ...
    skillRangeUp: { label: "战法距离提高", category: "range", summary: "主动战法有效距离增加。" },
    ...
    combo: { label: "连击", category: "attack", summary: "普通攻击后可额外进行一次普通攻击。" },
    ...
    taunt: { label: "挑衅", category: "control", negative: true, control: true, summary: "普通攻击优先攻击挑衅来源。" },
    healBlocked: { label: "禁疗", category: "heal", negative: true, summary: "无法恢复兵力。" },
    emergencyHeal: { label: "急救", category: "heal", summary: "受到伤害后按概率恢复伤兵。" },
